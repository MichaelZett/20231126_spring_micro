...
insert into customer (BIRTHDATE,VIP,ID,VERSION,UUID,LAST_NAME,NAME) values ('1983-07-11',false,nextval('CUSTOMER_SEQ'),0,'68111897-39bd-4db6-9c6a-f7080690fb2a','Schuhmacher','Frank');
insert into customer (BIRTHDATE,VIP,ID,VERSION,UUID,LAST_NAME,NAME) values ('2007-07-11',false,nextval('CUSTOMER_SEQ'),0,'77c4f5dd-b29c-4976-9c30-47cc00f0f7d2','Müller','Wiebke');
insert into customer (BIRTHDATE,VIP,ID,VERSION,UUID,LAST_NAME,NAME) values ('2009-07-11',true,nextval('CUSTOMER_SEQ'),0,'984008c7-afee-4067-955e-0b55a21de59e','Junge','Tom');
