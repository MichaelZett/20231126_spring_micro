...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<Object> handleCustomerTooYoungException(CustomerTooYoungException customerTooYoungException, WebRequest request) {
        return buildErrorResponse(customerTooYoungException, HttpStatus.UNPROCESSABLE_ENTITY, request);    }
